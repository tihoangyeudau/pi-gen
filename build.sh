...
export FIRST_USER_NAME=${FIRST_USER_NAME:-rml}
export FIRST_USER_PASS=${FIRST_USER_PASS:-0966142557}
export RELEASE=${RELEASE:-buster}
export WPA_ESSID=${WPA_ESSID:-Trung Ngoc AX6}
export WPA_PASSWORD=${WPA_PASSWORD:-0966142557}
export WPA_COUNTRY=${WPA_COUNTRY:-VN}
